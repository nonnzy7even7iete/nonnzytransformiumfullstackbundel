...
// Import dynamique du Globe (Chemin ui inchangé selon tes instructions)
const World = dynamic(
...
export default function ResumeExecutifPage() {
  ...
  // Sécurité anti-crash : évite le mismatch de rendu Serveur/Client
  if (!mounted)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-[#020408]">
      ...
      {/* SECTION 1 : CONTENT (LOGS & CARDS) - Priorité UX */}
      <section className="relative z-30 w-full min-h-[80vh] pt-32 pb-20 px-6 flex items-center justify-center border-b border-black/[0.03] dark:border-white/[0.03]">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center md:justify-end min-h-[350px]">
            {/* Injection des données items ici */}
      ...
      <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        {/* Le globe ne bloque plus le scroll car il est en z-0 */}
        <motion.div
          initial={{ opacity: 0 }}
        ...
        {/* Gradient de fond pour lier au footer */}
