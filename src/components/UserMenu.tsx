  ...
  return (
    <div className="relative font-sans">
      ...
      <button
        ...
        className="w-7 h-72 rounded-full overflow-hidden border border-white/20 hover:border-green-400/60 transition-colors focus:outline-none focus:ring-2 focus:ring-green-400"
      >
        {session.user?.image ? (
          <img
