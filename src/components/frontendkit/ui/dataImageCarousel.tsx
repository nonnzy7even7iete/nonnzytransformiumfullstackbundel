 ...
 * @status POOLISH : Fermeture par clic sur l'overlay, suppression de l'icône X.
 */
    ...
    <section className="relative z-10 w-full max-w-[1100px] mx-auto px-6 lg:px-16 pb-64">
      <div className="border-t border-[var(--border-color)] pt-32">
        <TextGenerateEffect className="text-[var(--foreground)]">
          {/* HEADER : TITRE ET INTRODUCTION (RESTAURÉ À 100%) */}
          ...
          {/* GRILLE DE POINTS CLÉS (RESTRICTION DE MODIFICATION) */}
          ...
          {/* CORPS DE L'ANALYSE (INTÉGRALITÉ RÉTABLIE) */}
          <div className="space-y-40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-l border-[var(--border-color)] pl-8 lg:pl-0 lg:border-none animate-target opacity-0">
              ...
              <div className="lg:col-span-8 space-y-6">
                <p className="text-lg leading-relaxed opacity-80">
                  ...
                  de construction, extension industrielle et urbaine.
                </p>
                <p className="text-lg leading-relaxed opacity-80">
                  <strong>Métallurgie :</strong> produit des équipements pour
                  d’autres industries, permettant de scaler rapidement.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-l border-[var(--border-color)] pl-8 lg:pl-0 lg:border-none animate-target opacity-0">
              ...
              <div className="lg:col-span-8 space-y-6">
                <p className="text-xl font-black tracking-tight pt-6">
                  ...
                  industries peuvent croître sans limites.
                </p>
              </div>
            </div>
            ...
            {/* CONCLUSION FINALE AVEC DÉCLENCHEUR */}
            <footer className="pt-20 text-center space-y-12 animate-target opacity-0">
              ...
              <div className="max-w-3xl mx-auto">
                <div className="text-xl md:text-2xl font-bold opacity-90 leading-relaxed mb-12">
      ...
      {/* OVERLAY DU CARROUSEL 3D : LOGIQUE POOLISH */}
      <AnimatePresence>
        {showCarousel && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            // e.stopPropagation : Empêche la fermeture lors du clic sur le fond.
            // e.currentTarget === e.target : Garantit la fermeture UNIQUEMENT si on clique sur l'overlay, pas sur le carrousel.
            onClick={(e) => {
          ...
          >
            {/* L'appel du composant 3D. 
                onClick={(e) => e.stopPropagation()} : Protection vitale pour éviter la fermeture lors de l'interaction (Drag/Clic).
            */}
